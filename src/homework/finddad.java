...
public class finddad {
    ...
    // Example: Input the year: testdadtest Output :dad Input the year: testd7dtest Output :
    // dad Input the year: testdodtest Output :dad Input the year: testDudtest Output :dad
