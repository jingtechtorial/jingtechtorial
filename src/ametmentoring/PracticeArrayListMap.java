...
public class PracticeArrayListMap {
    ...
    String[] chips = {"Lay", "Fritos", "Cheetos", "Doritos", "Ruffles", "Pringles"};
    ...
    double[] chipPrice = {3.99, 2.99, 4.99, 3.49, 1.99, 2.69};
